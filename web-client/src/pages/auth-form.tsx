...
const AuthPage: React.FC = () => {
    ...
    const togglePage = () => setIsSignUpPage(!isSignUpPage);
...
const SignUp: React.FC<SignUpProps> = ({ onTogglePage }) => {
    ...
    const [selectedGroup, setSelectedGroup] = useState<string>('TASKER');
                ...
                <div>
                    ...
                    <div>
                        <label>
                            <input
                                type="radio"
                                value="TASKER"
                                checked={selectedGroup === 'TASKER'}
                                onChange={() => setSelectedGroup('TASKER')}
                            />
                            Tasker
                        </label>
                        <label>
                            <input
                                type="radio"
                                value="CUSTOMER"
                                checked={selectedGroup === 'CUSTOMER'}
                                onChange={() => setSelectedGroup('CUSTOMER')}
                            />
                            Customer
                        </label>
                    </div>
                    ...
                    {codeDeliveryDetails && (
                        <p>
                            ...
                            via {codeDeliveryDetails.deliveryMedium} to {codeDeliveryDetails.destination}.
                        </p>
                    )}
                    <p>
